...
function default_2_position_tumb(hint_, device_, command_, arg_,sound_)
	...
	local	sound_ = sound_ or {SOUND_SW1}
...
elements["PNT_LIGHT_TAXI"] = default_2_position_tumb(_("Landing/Taxi Lights ON/OFF"), devices.LIGHTS, LIGHTS.LandTaxi, 12, TOGGLECLICK)
elements["PNT_LIGHT_NAV"] = default_2_position_tumb(_("Navigation Lights ON/OFF"), devices.LIGHTS, LIGHTS.Nav, 16, TOGGLECLICK)
elements["PNT_LIGHT_ACOL"] = default_2_position_tumb(_("Anti-Collision Lights ON/OFF"), devices.LIGHTS, LIGHTS.AntiCol, 17, TOGGLECLICK)

elements["PNT_BATTERY"] = default_2_position_tumb(_("Battery ON/OFF"), devices.ELECTRICAL, ELECTRICAL.Batt, 21, TOGGLECLICK)
elements["PNT_APU"] = default_2_position_tumb(_("APU ON/OFF"), devices.ELECTRICAL, ELECTRICAL.APU, 25, TOGGLECLICK)
elements["PNT_GEN_L"] = default_2_position_tumb(_("Generator Left ON/OFF"), devices.ELECTRICAL, ELECTRICAL.GenL, 26, TOGGLECLICK)
elements["PNT_GEN_R"] = default_2_position_tumb(_("Generator Right ON/OFF"), devices.ELECTRICAL, ELECTRICAL.GenR, 27, TOGGLECLICK)

elements["PNT_LMFD_POWER"] = default_button(_("MFD Power ON/OFF"), devices.MFD, LMFD.Power, 0, 1, {0,1}, TOGGLECLICK)
elements["PNT_RMFD_POWER"] = default_button(_("MFD Power ON/OFF"), devices.MFD, RMFD.Power, 0, 1, {0,1}, TOGGLECLICK)
elements["PNT_CMFD_POWER"] = default_button(_("MFD Power ON/OFF"), devices.MFD, CMFD.Power, 0, 1, {0,1}, TOGGLECLICK)
